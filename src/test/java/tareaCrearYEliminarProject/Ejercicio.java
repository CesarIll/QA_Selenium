package tareaCrearYEliminarProject;
...
public class Ejercicio {
    ...
    @Test
    public void loginTodoLyCreateAndDeleteProject() throws InterruptedException {
        String project = "Proyecto para eliminar";
        ...
        //6) Set NombrProject
        driver.findElement(By.xpath("//input[@id='NewProjNameInput']")).sendKeys(project);
        //7) Click Add button
        ...
        Assert.assertEquals("El proyecto no fue creado",project,actualResult);


        driver.findElement(By.xpath("//li[last()]//td[contains(.,'"+ project +"') and @class='ProjItemContent']")).click();
